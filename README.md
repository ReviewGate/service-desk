...
`feat/call-button` написана агентом по этим правилам — и pre-push её остановил (major: `tel:`
расходился с `sdPhone`); правка следующим коммитом, так и лежит в истории ветки.
